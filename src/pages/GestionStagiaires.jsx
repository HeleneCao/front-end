...
const GestionStagiaires = () => {
  return (
    ...
    <div className="overflow-x-auto">
      ...
      <h2 className="font-mono not-italic font-bold text-2xl leading-9 text-white">Liste des stagiaires</h2>
    </div>
    ...
    <button className="border-2 border-blue-500 rounded-full p-1 px-2 flex items-end">Ajouter un membre</button>
  </div>
  </div>
  </div>
  );
